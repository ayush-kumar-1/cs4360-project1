/**
* Script name: AirQuality.scala
* Purpose of script: CSCI 4360 Project 1 - Regression Analysis of UCI AirQuality Dataset
...
object AirQuality extends App {

    val air_quality = Relation.apply("../data/AirQualityUCI/AirQualityUCI.csv", "air_quality", 
                                domain=null, key = 0, eSep = ";", cPos = null)
    air_quality.show(5)

    val (x,y) = air_quality.toMatriDD(0 to 10, 11)
    ...
    */
    def plot_and_save (regMat: MatriD, path: String, basePath: String = "plots/AirQuality/Scala/")  = { 
